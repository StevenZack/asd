...
随着互联网的普及，人们之间的距离不断缩短，天南海北的人们虽然相距很远，但是有许多共同的话题的人们，该如何聚集在一起参与讨论与学习呢？现有的贴吧，论坛是一个好的去处，但是相互沟通的及时性难以保证，这是一款可以即时通讯软件，保证了这个方面，人们可以在通讯终端上交友聊天，结交好朋友，找到志趣相投的人。可以再讨论组里面向广大网友们提问，可以随时的参与到一个话题中来，也可以随时创建一个话题，来吸引有相同兴趣的人来参与到话题的讨论中。可以再讨论组里面向广大网友们提问，及时的吸引有相同经历，或者对这个话题感兴趣的人来帮助解决这个问题，从而提高人们解决问题的速度。根据创建的人的身份职业不同，所讨论的话题也不尽相同，可以协助解决更为专业的问题，如：对一个学生来说，可以在线创建一个关于高数问题的话题，有相同兴趣的学生或是这方面研究的老师就可以参与进来，来帮助同学们、朋友们实时的解决解决相应的高数题，创建的房间的问题问题范围也可以更小一些，聚集到一个问题上，最终实现人与人之间的合作共赢，互利互惠。

# 需求分析

现在的学生交互性更强，同时生活节奏也更加紧促，需要更为及时有效的反应问题以及解决问题，提高与老师的互动性，从而减少师生摩擦。同时又有强烈的求知欲望，知识面也越来越宽广，为了促进学生全面的的发展，需要涉及更多方面的内容，也更加的乐于助人，喜欢帮助别人；对于老师来说，希望更能及时布置任务，及时接受学生们反馈的问题，并予以解答，从而更好地了解学生情况，以及学生对知识的掌握情况。对于有空闲时间的在职人员，随着手机性能的提高，网络的普及，出去工作时间以外，大家更多的时间都是消耗在网络上，而这样一款app有助于其在第一时间找到与自己兴趣相关的话题并发表言论从而节约本就有限的休闲娱乐的时间。对于专职的家庭主妇及家政而言，可以有效的发布招聘启事，并通过讨论组的成员来了解哪一家家政服务更优秀，与此同时可以招聘一些短期的人员完成自己想要完成的各项任务等。

## 目标分析


这款APP想要为使用人员提供在线的实时的服务，通过这种及时性，以及互动性，为大家提供一个交流的平台。在平台上创建的讨论组可以是兴趣所驱，如：一个篮球爱好者的讨论组，一个日语学习兴趣组，一个羽毛球爱好者的兴趣组等等。也可以是为了解决某些具体的实际问题，如：了解毕业设计应该有哪几部分组成、某种化学反应应该具备那种条件才能反应完全等。更可以是师生、家庭沟通的平台，及时地反映问题，解决问题，进行良性沟通与互动，如：学生与学校领导在线讨论学校相关的设施问题与检查问题，使学生可以及时反映自己的心声，校方可以及时了解学生需求，从而创建和谐校园。同样也可以是同学之间交流的方式，如：在解决班级事务时，可以在线多人讨论，从而为班级做出更好的决策。单独的个体之间也可以创建房间，进行聊天。
...
在Android里面使用Fragment的时候，经常出现Null Pointer Exception。主要原因是我们在MainActivity里面调用了Fragment里面的组件，但是这个代码写在Activity的onCreate方法后面，也就是说，Fragment虽然是附属在Activity之上的，但是他的创建过程是在Activity的onCreate方法之后的，如果你再Fragment创建之前调用了Fragment里面的组件的方法，就会报空指针异常。

## 感想与展望

在制作这个聊天室App之后，深深的感觉到原来做义工简单的聊天室App，他的实现过程也这么复杂，你需要考虑框架的选择，考虑性能、考虑架构还有通讯协议等等一大堆的事情，最终只是为了实现一个聊天的功能，看来还是要不断的提升自身实力，不断的学习啊。
...
golang，又称go，是谷歌开发的一种计算机编程语言。它的开发始于2007年的谷歌，并于2009年向公众介绍。Go在谷歌的三个主要开发者是Robert Griesemer、Rob Pike和Ken Thompson。他们提出了一个目标，创建一种语言，松散地基于C编程语言的语法，这将消除诸如C++之类的“多余的垃圾”。因此，Go包含了其他现代语言的许多特性，例如方法和运算符重载、指针算术和类型继承。最终，该产品是一种静态类型的语言，有一个精致而强大的库，性能和速度无与伦比！走就够了！现在我们来谈谈Python。
